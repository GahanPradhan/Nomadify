        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {trips.map((trip) => (
              <Card 
                key={trip.id}
                className="bg-gradient-to-br from-slate-50 to-red-50 border-none hover:shadow-md transition-all"
              >
                <CardContent className="p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <Button 
                      size="sm" 
                      className="w-full bg-white text-slate-700 hover:bg-red-600 hover:text-white"
